---
name: archeolog-prospector
description: "Use this agent when you need to analyze and explore the codebase archaeology - discovering hidden patterns, dead code, legacy structures, technical debt, and historical artifacts in the code. This agent excels at finding forgotten implementations, deprecated patterns, orphaned files, and understanding how the codebase evolved over time."
model: opus
color: yellow
---
