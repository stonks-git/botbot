...
# Deliberate (conscious) memories (D-029)
DELIBERATE_INITIAL_ALPHA = 2.0
DELIBERATE_INITIAL_BETA = 3.0
DELIBERATE_SOURCE_TAG = "agent_deliberate"

# Priority injection bypass (D-033)
PRIORITY_IMPORTANCE_THRESHOLD = 0.95  # importance >= this bypasses w×s scoring
